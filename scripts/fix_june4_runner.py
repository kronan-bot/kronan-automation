"""
Recovery script: removes wrong June 4, 2026 data from master, re-processes with corrected file.
Usage: KRONAN_BASE=data python scripts/fix_june4_runner.py fix/kronan_june4_correct.xlsx
"""
